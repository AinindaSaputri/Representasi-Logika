  ...
  "cells": [
    {
      ...
      "metadata": {
        ...
        "id": "QyOSIQBHfDcz",
        "outputId": "76329059-aa88-4fb2-e2a1-54c4fcd90be5"
      },
      "outputs": [
        {
          "output_type": "stream",
      ...
      "source": [
        ...
        "kb.add_fact((\"Hadi\", \"orang tua dari\", \"Surya\"))\n",
        "kb.add_fact((\"Retno\", \"orang tua dari\", \"Desi\"))\n",
        "kb.add_fact((\"Retno\", \"orang tua dari\", \"Wahyu\"))\n",
        "kb.add_fact((\"Retno\", \"orang tua dari\", \"Rina\"))\n",
        "kb.add_fact((\"Retno\", \"orang tua dari\", \"Surya\"))\n",
        "kb.add_fact((\"Aininda\", \"orang tua dari\", \"Tari\"))\n",
        "kb.add_fact((\"Aininda\", \"orang tua dari\", \"Nurul\"))\n",
        "kb.add_fact((\"Aininda\", \"orang tua dari\", \"Yanto\"))\n",
        "kb.add_fact((\"Rina\", \"orang tua dari\", \"Hamzah\"))\n",
        "kb.add_fact((\"Surya\", \"orang tua dari\", \"Eka\"))\n",
        "kb.add_fact((\"Surya\", \"orang tua dari\", \"Mira\"))\n",
        "kb.add_fact((\"Surya\", \"orang tua dari\", \"Bastian\"))\n",
        ...
        "kb.add_fact((\"Wahyu\", \"saudara laki-laki dari\", \"Aininda\"))\n",
        "kb.add_fact((\"Aininda\", \"saudara laki-laki dari\", \"Desi\"))\n",
        "kb.add_fact((\"Aininda\", \"saudara laki-laki dari\", \"Rina\"))\n",
        "kb.add_fact((\"Aininda\", \"saudara laki-laki dari\", \"Wahyu\"))\n",
        ...
        "kb.add_fact((\"Desi\", \"saudara perempuan dari\", \"Aininda\"))\n",
        "kb.add_fact((\"Rina\", \"saudara perempuan dari\", \"Desi\"))\n",
        "kb.add_fact((\"Rina\", \"saudara perempuan dari\", \"Wahyu\"))\n",
        "kb.add_fact((\"Rina\", \"saudara perempuan dari\", \"Aininda\"))\n",
        ...
        "# Paman\n",
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Hamzah\"))\n",
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Eka\"))\n",
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Mira\"))\n",
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Bastian\"))\n",
        ...
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Tari\"))\n",
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Nurul\"))\n",
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Yanto\"))\n",
        "kb.add_fact((\"Aininda\", \"paman dari\", \"Hamzah\"))\n",
        ...
        "kb.add_fact((\"Aininda\", \"kakek dari\", \"Wanda\"))\n",
        "kb.add_fact((\"Aininda\", \"kakek dari\", \"Aji\"))\n",
        "kb.add_fact((\"Aininda\", \"kakek dari\", \"Gunawan\"))\n",
        "kb.add_fact((\"Aininda\", \"kakek dari\", \"Anggun\"))\n",
        "kb.add_fact((\"Aininda\", \"kakek dari\", \"Boy\"))\n",
        "# nenek\n",
